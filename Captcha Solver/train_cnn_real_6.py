...
train_data = np.stack([np.array(Image.open('./data/6_real_train_set/' + str(i) + ".jpg"))/255.0 for i in range(1, 60001)])
traincsv = open('./data/6_real_train_set/captcha_train.csv', 'r', encoding = 'utf8')
...
valicsv = open('./data/6_real_train_set/captcha_train.csv', 'r', encoding = 'utf8')
vali_data = np.stack([np.array(Image.open('./data/6_real_train_set/' + str(i) + ".jpg"))/255.0 for i in range(60001, 75001)])
valicsv = open('./data/6_real_train_set/captcha_train.csv', 'r', encoding = 'utf8')
...
filepath="./data/model/real_6_model.h5"
